...
class DotnetDependencyList:
    def __init__(self) -> None:
        self.csproj_files = [
            ...
            "https://raw.githubusercontent.com/GrillBot/rubbergodService/master/RubbergodService/RubbergodService.csproj",
            "https://raw.githubusercontent.com/GrillBot/rubbergodService/master/RubbergodService.Data/RubbergodService.Data.csproj"
        ]
        self.cache = cache
